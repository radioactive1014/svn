...
bool orogen_typekits::toCORBA( orogen::Corba::KUKACommanderData& corba, KUKACommanderData const& value )
{
    if (!toCORBA(corba.samples, value.samples)) return false;

    return true;
}
bool orogen_typekits::fromCORBA( KUKACommanderData& value, orogen::Corba::KUKACommanderData const& corba )
{
