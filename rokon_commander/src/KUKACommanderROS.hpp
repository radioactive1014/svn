...
#include "rokon_commander/check_position.h"
	...
	class KUKACommanderROS : public RTT::TaskContext{
	  ...
	  private:
		...
		ros::CallbackQueue callbackQueue;
         ...
         std::vector<double>  vectorPositionRos ;
		sensor_msgs::JointState pos ;
	  	InputPort< sensor_msgs::JointState> port_check_pos ;
	  	InputPort< std::vector<double> > port_vector_position_Ros;
		...
		//OperationCaller<void(void)> getCurrentState;
		...
		//bool checkPositionRos(rokon_commander::check_position::Request&, rokon_commander::check_position::Response& )
	};


/*

		inline bool KUKACommanderROS::checkPositionRos(rokon_commander::check_position::Request&, rokon_commander::check_position::Response&) {
		log(Debug) << "Call service check position" << endlog();
